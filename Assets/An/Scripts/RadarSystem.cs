...
//credit:https://www.youtube.com/watch?v=hIPC7kOV9DE&t=578s 
...
public class RadarSystem : MonoBehaviour
{
    ...
    void Update()
    {
        angletext.text = "Angle" + Camera.main.transform.eulerAngles.y;
    ...
    void OnGUI()
    {
        ...
        if (NavCompass)
        {
            ...
            GUIUtility.RotateAroundPivot(-Camera.main.transform.eulerAngles.y, inposition + new Vector2(Size / 2f, Size / 2f));
        }
